...
datetick('x','YYYY');
title('the truncated variance of PG');
box off; grid on;
xlabel('time');
...
datetick('x','YYYY');
legend('TV','RV')
title('the truncated variance and the realized variance of PG');
box off; grid on;
xlabel('time');
...
datetick('x','YYYY');
title('the quartic integrated variance of PG');
box off; grid on;
xlabel('time');
...
datetick('x','yyyy');
legend('CI_IV','TV');
title('confidence interval of truncated variance of PG');
box off; grid on;
xlabel('time');
ylabel('CI');
...
title('confidence interval of truncated variance on 2018 Oct.of PG');
box off; grid on;
xlabel('time');
ylabel('CI on 2018 Oct.');
print(f,'-dpng','-r200','figures/2E2');
close(f);
...
title('confidence interval of annualized truncated variance of PG');
box off; grid on;
xlabel('time');
ylabel('CI');
print(f,'-dpng','-r200','figures/2H2');
close(f);